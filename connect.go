...
func main() {
	...
	grpcEndpoint := "ff1d03c6-aaae-440c-b463-4508b2993d0f-us-east1.apps.astra-dev.datastax.com:443"
	...
	conn, err := grpc.Dial(grpcEndpoint, grpc.WithTransportCredentials(credentials.NewTLS(config)), grpc.WithBlock(),
		grpc.WithPerRPCCredentials(
			...
			auth.NewStaticTokenProvider("AstraCS:qTvPRvZTLygyfEZynXIRcOrs:cbd02f55e76e6e948673e8127bbf81feeb6a5564ccfe1f513cf73b9409cf70ed"),
		),
	)
